...
Original file is located at
    https://colab.research.google.com/drive/1tJYx0QmdgNsBIx8fw1O-XMTSbgdbj1Jp
...
W = np.matmul(X_total, np.transpose(X_total)) / (len(X_total[0]) - 1)
W
...
def plot_data(Z1=[],Z2=[],Z3=[],Z4=[]):
  ...
  if len(Z3)>0:
    ...
    ax1.scatter(Y3[0,:], Y3[1,:], s=100, c='g', marker="x")
  if len(Z4)>0:
    Y4=np.reshape(Z4,(2,-1))
    ax1.scatter(Y4[0,:], Y4[1,:], s=100, c=[colors[7]], marker="x")
  plt.show()  
  return None

plot_data(X_pos_2D, X_neg_2D, Alice, Bob)
